...
import Ue, { forwardRef as xn, createElement as Wr, useState as K, useRef as Br, useEffect as ge } from "react";
...
function Tn() {
  ...
  return s.NODE_ENV !== "production" && function() {
    ...
    var S = !1, L = !1, D = !1, G = !1, ce = !1, V;
    V = Symbol.for("react.module.reference");
    function xe(d) {
      return !!(typeof d == "string" || typeof d == "function" || d === n || d === a || ce || d === i || d === l || d === h || G || d === _ || S || L || D || typeof d == "object" && d !== null && (d.$$typeof === m || d.$$typeof === f || d.$$typeof === o || d.$$typeof === c || d.$$typeof === u || // This needs to include all possible module reference object
    ...
    var H = Object.assign, he = 0, me, Se, _t, wt, tt, bt, xt;
    function St() {
    }
    ...
    function Yt() {
      {
        if (he === 0) {
          me = console.log, Se = console.info, _t = console.warn, wt = console.error, tt = console.group, bt = console.groupCollapsed, xt = console.groupEnd;
          var d = {
            configurable: !0,
            enumerable: !0,
            value: St,
...
` + Be + d;
    ...
    function st(d, g) {
      ...
      var F;
      F = Ae.current, Ae.current = null, Yt();
      try {
        if (g) {
          var I = function() {
            throw Error();
...
`), X = k.stack.split(`
`), q = A.length - 1, z = X.length - 1; q >= 1 && z >= 0 && A[q] !== X[z]; )
            z--;
          for (; q >= 1 && z >= 0; q--, z--)
            if (A[q] !== X[z]) {
              if (q !== 1 || z !== 1)
...
` + A[q].replace(" at new ", " at ");
        ...
        fe = !1, Ae.current = F, R(), Error.prepareStackTrace = N;
      }
      var He = d ? d.displayName || d.name : "", $e = He ? qe(He) : "";
      return typeof d == "function" && ve.set(d, $e), $e;
    }
    function v(d, g, b) {
      return st(d, !1);
    }
    ...
    var M = Object.prototype.hasOwnProperty, Q = {}, ne = P.ReactDebugCurrentFrame;
    function ze(d) {
      if (d) {
        var g = d._owner, b = T(d.type, d._source, g ? g.type : null);
        ne.setExtraStackFrame(b);
      } else
        ne.setExtraStackFrame(null);
    }
    function kt(d, g, b, k, N) {
      {
          ...
          if (F(d, I)) {
            ...
            try {
              if (typeof d[I] != "function") {
                var X = Error((k || "React class") + ": " + b + " type `" + I + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof d[I] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw X.name = "Invariant Violation", X;
              }
              A = d[I](g, I, k, b, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (q) {
              A = q;
            }
            A && !(A instanceof Error) && (ze(N), O("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", k || "React class", b, I, typeof A), ze(null)), A instanceof Error && !(A.message in Q) && (Q[A.message] = !0, ze(N), O("Failed %s type: %s", b, A.message), ze(null));
          }
      }
    }
    ...
    function on(d, g) {
      if (typeof d.ref == "string" && nt.current && g && nt.current.stateNode !== g) {
        ...
        Jt[b] || (O('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', J(nt.current.type), d.ref), Jt[b] = !0);
      }
    }
    function cn(d, g) {
      {
    ...
    function dn(d, g, b, k, N) {
      {
        var F, I = {}, A = null, X = null;
        b !== void 0 && (Rr(b), A = "" + b), an(g) && (Rr(g.key), A = "" + g.key), nn(g) && (X = g.ref, on(g, N));
        for (F in g)
          M.call(g, F) && !sn.hasOwnProperty(F) && (I[F] = g[F]);
        if (d && d.defaultProps) {
        ...
        return un(d, A, X, N, k, nt.current, I);
      }
    }
    ...
    function Lr(d, g) {
      {
        ...
        Mr[b] = !0;
        var k = "";
        d && d._owner && d._owner !== Kt.current && (k = " It was passed a child from " + J(d._owner.type) + "."), Ve(d), O('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', b, k), Ve(null);
      }
    }
    function Nr(d, g) {
      {
    ...
    function Fr(d, g, b, k, N, F) {
      {
        ...
        if (!I) {
          ...
          X ? A += X : A += Dr();
          var q;
          d === null ? q = "null" : Gt(d) ? q = "array" : d !== void 0 && d.$$typeof === t ? (q = "<" + (J(d.type) || "Unknown") + " />", A = " Did you accidentally export a JSX literal instead of a component?") : q = typeof d, O("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", q, A);
        }
        var z = dn(d, g, b, N, F);
        if (z == null)
          return z;
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`, Zt, $e, wn, $e), Ur[$e + Zt] = !0;
    ...
    var yn = vn, _n = mn;
    at.Fragment = n, at.jsx = yn, at.jsxs = _n;
  }(), at;
}
var jn = {};
jn.NODE_ENV === "production" ? dr.exports = On() : dr.exports = Tn();
var p = dr.exports, hr, Pn = {}, Et = Sn;
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const Rn = (s) => s.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase().trim(), be = (s, e) => {
  const t = xn(
    ({
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const Dn = be("Minus", [["path", { d: "M5 12h14", key: "1ays0h" }]]);
/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
var te = {}, Or = {}, Lt = {}, mt = {}, Nt = {}, Ut = {}, Hn = function() {
  if (typeof self < "u")
    return self;
  if (typeof window < "u")
    return window;
...
const Yn = Qe.fetch, Ss = Qe.fetch.bind(Qe), ks = Qe.Headers, Gn = Qe.Request, Jn = Qe.Response, Ze = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Headers: ks,
  Request: Gn,
  Response: Jn,
...
const li = Bt;
Wt.DEFAULT_HEADERS = { "X-Client-Info": `postgrest-js/${li.version}` };
var Os = oe && oe.__importDefault || function(s) {
  return s && s.__esModule ? s : { default: s };
};
Object.defineProperty(Or, "__esModule", { value: !0 });
const ui = Os(Lt), di = Os(mt), hi = Wt;
let fi = class Ts {
...
const js = et(Or);
te.PostgrestClient = js.default;
const Ps = et(Lt);
te.PostgrestQueryBuilder = Ps.default;
const Cs = et(mt);
te.PostgrestFilterBuilder = Cs.default;
const Rs = et(Nt);
te.PostgrestTransformBuilder = Rs.default;
const As = et(Ut);
te.PostgrestBuilder = As.default;
const $s = et(Ft);
te.PostgrestError = $s.default;
var gi = te.default = {
...
const {
  ...
  PostgrestBuilder: hl,
  PostgrestError: fl
} = gi, mi = "2.11.2", vi = { "X-Client-Info": `realtime-js/${mi}` }, yi = "1.0.0", Is = 1e4, _i = 1e3;
var Xe;
(function(s) {
...
const Hr = (s, e, t = {}) => {
  ...
  return s;
}, Oi = (s) => typeof s == "string" ? s.replace(" ", "T") : s, Ls = (s) => {
  let e = s;
...
class Tr {
  constructor(e, t = { config: {} }, r) {
    ...
    }), this.presence = new ht(this), this.broadcastEndpointURL = Ls(this.socket.endPoint) + "/api/broadcast", this.private = this.params.config.private || !1;
  }
      ...
      throw "tried to subscribe multiple times. 'subscribe' can only be called a single time per channel instance";
    {
      ...
      this.socket.accessTokenValue && (c.access_token = this.socket.accessTokenValue), this.updateJoinPayload(Object.assign({ config: u }, c)), this.joinedOnce = !0, this._rejoin(t), this.joinPush.receive("ok", async ({ postgres_changes: l }) => {
        ...
        if (this.socket.setAuth(), l === void 0) {
          ...
          for (let y = 0; y < m; y++) {
            const x = f[y], { filter: { event: C, schema: P, table: O, filter: E } } = x, S = l && l[y];
            if (S && S.event === C && S.schema === P && S.table === O && S.filter === E)
    ...
    ["insert", "update", "delete"].includes(a) ? (n = this.bindings.postgres_changes) === null || n === void 0 || n.filter((m) => {
      ...
      if (["broadcast", "presence", "postgres_changes"].includes(a))
        if ("id" in m) {
          ...
          const E = (P = (C = m == null ? void 0 : m.filter) === null || C === void 0 ? void 0 : C.event) === null || P === void 0 ? void 0 : P.toLocaleLowerCase();
      ...
      if (typeof f == "object" && "ids" in f) {
        const _ = f.data, { schema: y, table: x, commit_timestamp: C, type: P, errors: O } = _;
...
class Ci {
  ...
  constructor(e, t) {
    var r;
    this.accessTokenValue = null, this.apiKey = null, this.channels = [], this.endPoint = "", this.httpEndpoint = "", this.headers = vi, this.params = {}, this.timeout = Is, this.heartbeatIntervalMs = 3e4, this.heartbeatTimer = void 0, this.pendingHeartbeatRef = null, this.ref = 0, this.logger = Ti, this.conn = null, this.sendBuffer = [], this.serializer = new wi(), this.stateChangeCallbacks = {
      open: [],
      close: [],
      error: [],
      message: []
  ...
  connect() {
    if (!this.conn) {
      ...
      }), import("./browser-DC-2Vivv.js").then((e) => e.b).then(({ default: e }) => {
...
const Hi = { "X-Client-Info": `supabase-js-${dt}/${Vi}` }, Yi = {
  headers: Hi
}, Gi = {
  schema: "public"
}, Ji = {
...
}, Zi = () => typeof Headers > "u" ? ks : Headers, ea = (s, e, t) => {
  const r = Qi(t), n = Zi();
...
const Fs = "2.67.3", na = "http://localhost:9999", ia = "supabase.auth.token", aa = { "X-Client-Info": `gotrue-js/${Fs}` }, Xr = 10, yr = "X-Supabase-Api-Version", Ws = {
  "2024-01-01": {
...
const Bs = (s) => {
  let e;
  return s ? e = s : typeof fetch > "u" ? e = (...t) => Promise.resolve().then(() => Ze).then(({ default: r }) => r(...t)) : e = fetch, (...t) => e(...t);
}, ua = (s) => typeof s == "object" && s !== null && "status" in s && "ok" in s && "json" in s && typeof s.json == "function", qs = async (s, e, t) => {
...
class gt {
  ...
  constructor(e) {
    var t, r;
    this.memoryStorage = null, this.stateChangeEmitters = /* @__PURE__ */ new Map(), this.autoRefreshTicker = null, this.visibilityChangedCallback = null, this.refreshingDeferred = null, this.initializePromise = null, this.detectSessionInUrl = !0, this.hasCustomAuthorizationHeader = !1, this.suppressGetSessionWarning = !1, this.lockAcquired = !1, this.pendingInLock = [], this.broadcastChannel = null, this.logger = console.log, this.instanceID = gt.nextInstanceID, gt.nextInstanceID += 1, this.instanceID > 0 && pe() && console.warn("Multiple GoTrueClient instances detected in the same browser context. It is not an error, but this should be avoided as it may produce undefined behavior when used concurrently under the same storage key.");
    ...
    }, this.persistSession ? n.storage ? this.storage = n.storage : ft() ? this.storage = Da : (this.memoryStorage = {}, this.storage = ss(this.memoryStorage)) : (this.memoryStorage = {}, this.storage = ss(this.memoryStorage)), pe() && globalThis.BroadcastChannel && this.persistSession && this.storageKey) {
      try {
  ...
  async signUp(e) {
    ...
    try {
      ...
      if ("email" in e) {
        ...
        let m = null, _ = null;
        this.flowType === "pkce" && ([m, _] = await Ge(this.storage, this.storageKey)), i = await $(this.fetch, "POST", `${this.url}/signup`, {
          headers: this.headers,
  ...
  async _getUser(e) {
    try {
      return e ? await $(this.fetch, "GET", `${this.url}/user`, {
        ...
        if (o)
          throw o;
        return !(!((r = a.session) === null || r === void 0) && r.access_token) && !this.hasCustomAuthorizationHeader ? { data: { user: null }, error: new Ee() } : await $(this.fetch, "GET", `${this.url}/user`, {
          headers: this.headers,
      ...
      if (j(t))
        return Sa(t) && (await this._removeSession(), await Tt(this.storage, `${this.storageKey}-code-verifier`)), { data: { user: null }, error: t };
      throw t;
    }
  }
  /**
  ...
  async _getSessionFromURL(e, t) {
    try {
      ...
      if (t === "pkce") {
        ...
        const { data: P, error: O } = await this._exchangeCodeForSession(e.code);
        if (O)
          throw O;
        ...
        try {
          ...
          try {
            return await this._useSession(async (t) => {
              ...
              this._debug("#_autoRefreshTokenTick()", `access token expires in ${n} ticks, a tick lasts ${ct}ms, refresh threshold is ${ns} ticks`), n <= ns && await this._callRefreshToken(r.refresh_token);
            });
          } catch (t) {
...
function Ys(s) {
  const e = ue(s), t = e.getFullYear(), r = Ne(s, 0);
  r.setFullYear(t + 1, 0, 4), r.setHours(0, 0, 0, 0);
  const n = Mt(r), i = Ne(s, 0);
...
function Do(s) {
  const e = ue(s), t = +Mt(e) - +Ka(e);
  return Math.round(t / Hs) + 1;
}
function Gs(s, e) {
  var l, h, f, m;
  const t = ue(s), r = t.getFullYear(), n = zt(), i = (e == null ? void 0 : e.firstWeekContainsDate) ?? ((h = (l = e == null ? void 0 : e.locale) == null ? void 0 : l.options) == null ? void 0 : h.firstWeekContainsDate) ?? n.firstWeekContainsDate ?? ((m = (f = n.locale) == null ? void 0 : f.options) == null ? void 0 : m.firstWeekContainsDate) ?? 1, a = Ne(s, 0);
  a.setFullYear(r + 1, 0, i), a.setHours(0, 0, 0, 0);
  const o = pt(a, e), c = Ne(s, 0);
...
function Mo(s, e) {
  var o, c, u, l;
  const t = zt(), r = (e == null ? void 0 : e.firstWeekContainsDate) ?? ((c = (o = e == null ? void 0 : e.locale) == null ? void 0 : o.options) == null ? void 0 : c.firstWeekContainsDate) ?? t.firstWeekContainsDate ?? ((l = (u = t.locale) == null ? void 0 : u.options) == null ? void 0 : l.firstWeekContainsDate) ?? 1, n = Gs(s, e), i = Ne(s, 0);
  return i.setFullYear(n, 0, r), i.setHours(0, 0, 0, 0), pt(i, e);
}
function Lo(s, e) {
  const t = ue(s), r = +pt(t, e) - +Mo(t, e);
...
function us(s, e) {
  return s % 60 === 0 ? (s > 0 ? "-" : "+") + U(Math.abs(s) / 60, 2) : Me(s, e);
}
function Me(s, e = "") {
...
function Ct(s, e, t) {
  var l, h, f, m;
  const r = zt(), n = r.locale ?? $o, i = r.firstWeekContainsDate ?? ((h = (l = r.locale) == null ? void 0 : l.options) == null ? void 0 : h.firstWeekContainsDate) ?? 1, a = r.weekStartsOn ?? ((m = (f = r.locale) == null ? void 0 : f.options) == null ? void 0 : m.weekStartsOn) ?? 0, o = ue(s);
  if (!Qa(o))
...
function rc() {
  ...
  return s.NODE_ENV !== "production" && function() {
    ...
    function m(E, S, L) {
      ...
      return u(function() {
        V.value = D, V.getSnapshot = S, _(V) && xe({
          inst: V
        });
      }, [E, D, S]), c(function() {
        _(V) && xe({
    ...
    var x = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", C = !x, P = C ? y : m, O = e.useSyncExternalStore !== void 0 ? e.useSyncExternalStore : P;
...
function sc() {
  ...
  return ar.useSyncExternalStoreWithSelector = function(u, l, h, f, m) {
    var _ = i(null);
    if (_.current === null) {
    ...
    _ = o(function() {
      function C(L) {
        if (!P) {
          if (P = !0, O = L, L = f(L), m !== void 0 && y.hasValue) {
            var D = y.value;
            if (m(D, L)) return E = D;
          }
          return E = L;
        ...
        var G = f(L);
        return m !== void 0 && m(D, G) ? D : (O = L, E = G);
      }
      var P = !1, O, E, S = h === void 0 ? null : h;
      return [function() {
        return C(l());
      ...
      var P = c(function() {
        var L = !1, D, G, ce = function(de) {
          ...
          if (n(he, de))
            return me;
          var Se = _(de);
          return y !== void 0 && y(me, Se) ? me : (D = de, G = Se, Se);
        }, V = m === void 0 ? null : m, xe = function() {
          return ce(f());
        }, Re = V === null ? void 0 : function() {
          return ce(V());
        };
        return [xe, Re];
      }, [f, m, _, y]), O = P[0], E = P[1], S = i(h, O, E);
      return o(function() {
...
var wc = (s) => typeof s == "function", Sr = (s, e) => wc(s) ? s(e) : s, bc = /* @__PURE__ */ (() => {
  let s = 0;
  return () => (++s).toString();
})(), xc = /* @__PURE__ */ (() => {
  let s;
...
})(), Sc = 20, $t = /* @__PURE__ */ new Map(), kc = 1e3, bs = (s) => {
  if ($t.has(s)) return;
  let e = setTimeout(() => {
...
}, Oc = [], ur = { toasts: [], pausedAt: void 0 }, Ht = (s) => {
  ur = kr(ur, s), Oc.forEach((e) => {
    e(ur);
  });
}, Tc = (s, e = "blank", t) => ({ createdAt: Date.now(), visible: !0, type: e, ariaProps: { role: "status", "aria-live": "polite" }, message: s, pauseDuration: 0, ...t, id: (t == null ? void 0 : t.id) || bc() }), yt = (s) => (e, t) => {
  let r = Tc(e, s, t);
...
se.memo(({ toast: s, position: e, style: t, children: r }) => {
  let n = s.height ? Gc(s.position || e || "top-center", s.visible) : { opacity: 0 }, i = se.createElement(Wc, { toast: s }), a = se.createElement(Yc, { ...s.ariaProps }, Sr(s.message, s));
  ...
  sendMessage: async (t, r) => {
    ...
    try {
      ...
      if (m.live_mode)
        ...
        try {
          const { response: x, isLiveChatRequested: C } = await Jc(t, r, o, l);
          ...
          const P = {
            ...
            sender_type: "bot",
            user_id: null
          }, { error: O } = await W.from("messages").insert(P);
          if (O) throw O;
          if (C) {
...
})), xs = "chatbot_session_id", Xc = 180, At = {
  chatWidth: "380px",
  chatHeight: "380px",
...
function el({ domainId: s }) {
  var st;
  const [e, t] = K(!1), [r, n] = K(""), [i, a] = K([]), [o, c] = K([]), [u, l] = K("history"), [h, f] = K(null), [m, _] = K(!1), [y] = K(/* @__PURE__ */ new Set()), [x, C] = K(null), [P, O] = K(null), E = Br(null), [S, L] = K(!1), D = Br(null), { sendMessage: G } = Kc(), [ce, V] = K(!1), [xe, Re] = K(window.innerWidth), [de, J] = K(!0);
  ge(() => {
    const v = () => {
  ...
  const H = () => window.matchMedia("(max-width: 640px)").matches, he = (v, w) => w.some(
    (T) => (
      // Check for exact ID match
      T.id === v.id || // Check for temp ID being replaced by real ID
      T.id.startsWith("temp-") && T.content === v.content && T.sender_type === v.sender_type || // Check for exact content match within a small time window (2 seconds)
      T.content === v.content && T.sender_type === v.sender_type && Math.abs(new Date(T.created_at).getTime() - new Date(v.created_at).getTime()) < 2e3
    )
  );
  ge(() => {
    if (!P) return;
    ...
    const v = W.channel("conversations-updates").on(
      ...
      (w) => {
        w.eventType === "UPDATE" && (c(
          (T) => T.map(
            (M) => M.id === w.new.id ? { ...M, ...w.new } : M
          )
        ), w.new.id === h && L(w.new.status === "archived"));
      }
    ).subscribe();
    return () => {
      v.unsubscribe();
    ...
    var v, w, T;
    e && (i.length > 0 || S) && ((v = E.current) == null || v.scrollIntoView({ behavior: "smooth" })), e && ((w = o.find((M) => M.id === h)) != null && w.live_mode) && ((T = E.current) == null || T.scrollIntoView({ behavior: "smooth" }));
  }, [i, e, S, h]);
  const me = async () => {
    if (P)
      try {
        const { data: v, error: w } = await W.from("conversations").select("*").eq("session_id", P).order("last_message_at", { ascending: !1 });
        if (w) throw w;
        c(v || []);
      } catch (v) {
  ...
  const Se = async () => {
    o.filter((v) => v.status === "active").length >= 5 || (a([]), f(null), L(!1), ve(null), V(!1), l("chat"));
  }, _t = () => {
    l("history"), a([]), f(null), L(!1), me();
  }, wt = async (v) => {
    try {
      f(v.id), L(v.status === "archived"), ve(null), V(!1);
      const { data: w } = await W.from("messages").select("*").eq("conversation_id", v.id).order("created_at", { ascending: !0 });
      w && (a(w), y.clear(), w.forEach((T) => y.add(T.id))), v.status === "archived" && ve(v.rating || null), l("chat");
    } catch (w) {
  ...
  ge(() => {
    ...
    const v = W.channel(`conversation-status:${h}`).on(
      ...
      (w) => {
        w.new.status === "archived" ? (L(!0), tt()) : L(!1);
      }
    ).subscribe();
    return () => {
      v.unsubscribe();
  ...
  ge(() => {
    ...
    const v = W.channel(`messages-${h}`).on(
      ...
      (w) => {
        if (console.log("Received real-time event:", w), w.eventType === "INSERT") {
          const T = w.new;
          console.log("New message:", T), a((M) => {
            if (he(T, M))
              return console.log("Message already exists, skipping"), M;
            const Q = M.filter(
              (ne) => !(ne.id.startsWith("temp-") && ne.content === T.content && ne.sender_type === T.sender_type)
            );
            return y.add(T.id), T.sender_type === "bot" && tt(), console.log("Adding new message to state"), [...Q, T];
          });
        }
      }
    );
    ...
    (async () => {
      ...
      w || (w = window.crypto.randomUUID(), localStorage.setItem(xs, w)), O(w), await bt(w);
    })();
  }, []);
  const bt = async (v) => {
    try {
      const { data: w, error: T } = await W.from("conversations").select("*").eq("session_id", v).eq("status", "active").order("last_message_at", { ascending: !1 }).limit(1);
      if (T) throw T;
      if (!w || w.length === 0) {
        console.log("No active conversations found for this session");
        return;
      }
      const M = w[0], Q = /* @__PURE__ */ new Date();
      if (Q.setDate(Q.getDate() - Xc), new Date(M.last_message_at) < Q) {
        await W.from("conversations").update({ status: "archived" }).eq("id", M.id);
        return;
      }
      f(M.id);
      const { data: ne } = await W.from("messages").select("*").eq("conversation_id", M.id).order("created_at", { ascending: !0 });
      if (ne) {
        const ze = ne.filter((kt) => y.has(kt.id) ? !1 : (y.add(kt.id), !0));
        a(ze);
      }
    } catch (w) {
    ...
    try {
      ...
      if (!v) {
        ...
        const { data: Q, error: ne } = await W.from("conversations").insert({
          domain_id: s,
          user_id: M.id,
          session_id: P,
      ...
      const { data: w, error: T } = await W.from("conversations").insert({
        domain_id: s,
        user_id: v.id,
        session_id: P,
        last_message_at: (/* @__PURE__ */ new Date()).toISOString(),
    ...
    try {
      ...
      a((Q) => he(M, Q) ? Q : [...Q, M]), await G(v, T), n("");
    } catch (w) {
    ...
    v.preventDefault(), !(!r.trim() || m) && await St(r.trim());
  };
  ge(() => {
    s && (async () => {
      try {
        ...
        console.error("Error fetching chatbot config:", w), Ae({
          chatbotName: "Friendly Assistant",
          greetingMessage: "Hello! How can I help you today?",
          color: "#FF6B00",
          headerTextColor: "#000000",
  ...
  const [R, Ae] = K({
    ...
    if (h)
      try {
        ...
        v && (a(v), v.forEach((w) => y.add(w.id)));
      } catch (v) {
        console.error("Error refreshing chat:", v), C("Failed to refresh chat");
      }
  }, [fe, ve] = K(null), rt = async (v) => {
    if (h)
      try {
        const { error: w } = await W.from("conversations").update({ rating: v }).eq("id", h);
        if (w) throw w;
        ve(v), c(
          (T) => T.map(
            (M) => M.id === h ? { ...M, rating: v } : M
          )
        );
      } catch (w) {
                  ...
                  children: u === "history" ? /* @__PURE__ */ p.jsxs("div", { className: "space-y-4 h-full", children: [
                      ...
                      "button",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ p.jsxs("div", { className: "flex justify-between items-center mb-1", children: [
                            /* @__PURE__ */ p.jsx("span", { className: "text-sm font-medium text-gray-900", children: Ct(new Date(v.created_at), "PPP") }),
                          ...
                          /* @__PURE__ */ p.jsxs("p", { className: "text-sm text-gray-600", children: [
                            "Last message: ",
                            Ct(new Date(v.last_message_at), "p")
                          ] })
                        ]
                      },
                      v.id
                    ...
                    u === "chat" && /* @__PURE__ */ p.jsxs("div", { className: "flex gap-2", children: [
                      ...
                      /* @__PURE__ */ p.jsxs("div", { className: "p-3 rounded-lg max-w-[80%]", style: { backgroundColor: R.agentMessageColor }, children: [
                        ...
                        /* @__PURE__ */ p.jsx("span", { className: "text-xs mt-1 block opacity-75", style: { color: R.agentMessageTextColor }, children: Ct(/* @__PURE__ */ new Date(), "h:mm a") })
                      ] })
                    ] }),
                    i.map((v) => /* @__PURE__ */ p.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          v.sender_type === "bot" && /* @__PURE__ */ p.jsx(It, { size: "sm", config: R }),
                          /* @__PURE__ */ p.jsxs(
                            "div",
                            {
                              className: "p-3 rounded-lg max-w-[80%]",
                              style: {
                                backgroundColor: v.sender_type === "user" ? R.userMessageColor : R.agentMessageColor
                              },
                              children: [
                                /* @__PURE__ */ p.jsx("p", { className: "text-sm", style: {
                                  color: v.sender_type === "user" ? R.userMessageTextColor : R.agentMessageTextColor
                                }, children: v.content }),
                                /* @__PURE__ */ p.jsx("span", { className: "text-xs mt-1 block opacity-75", style: {
                                  color: v.sender_type === "user" ? R.userMessageTextColor : R.agentMessageTextColor
                                }, children: Ct(new Date(v.created_at), "h:mm a") })
                              ]
                            }
                          ),
                    ...
                    m && !S && !((st = o.find((v) => v.id === h)) != null && st.live_mode) && /* @__PURE__ */ p.jsx(Qc, { config: R }),
...
//# sourceMappingURL=main-NsFTDBcB.js.map
