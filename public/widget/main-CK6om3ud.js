...
class Pi {
  ...
  connect() {
    if (!this.conn) {
      ...
      }), import("./browser-bUFh_wr4.js").then((e) => e.b).then(({ default: e }) => {
...
const Jc = async (s, e, t, r) => {
  ...
  sendMessage: async (t, r) => {
    ...
    try {
      const { data: i } = await U.from("conversations").select("domain_id").eq("id", r).single(), { data: a } = await U.from("domain_settings").select("chatbot_name, prompt").eq("domain_id", i == null ? void 0 : i.domain_id).single(), { data: o } = await U.from("training_data").select("content").eq("domain_id", i == null ? void 0 : i.domain_id).single(), c = a == null ? void 0 : a.chatbot_name, u = a == null ? void 0 : a.prompt, l = ((n = o == null ? void 0 : o.content) == null ? void 0 : n.trim()) || "";
      if (!c)
...
//# sourceMappingURL=main-CK6om3ud.js.map
