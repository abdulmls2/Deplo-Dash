...
import Ue, { forwardRef as bn, createElement as Fr, useState as K, useRef as Wr, useEffect as ge } from "react";
...
function On() {
  ...
  return s.NODE_ENV !== "production" && function() {
    ...
    var H = Object.assign, he = 0, xe, Se, _t, wt, rt, bt, xt;
    function St() {
    }
    ...
    function Ht() {
      {
        if (he === 0) {
          xe = console.log, Se = console.info, _t = console.warn, wt = console.error, rt = console.group, bt = console.groupCollapsed, xt = console.groupEnd;
          var d = {
            configurable: !0,
            enumerable: !0,
            value: St,
...
`), X = k.stack.split(`
`), q = R.length - 1, z = X.length - 1; q >= 1 && z >= 0 && R[q] !== X[z]; )
            z--;
          for (; q >= 1 && z >= 0; q--, z--)
            if (R[q] !== X[z]) {
              if (q !== 1 || z !== 1)
...
` + R[q].replace(" at new ", " at ");
        ...
        fe = !1, Ae.current = F, A(), Error.prepareStackTrace = L;
      }
      var Ye = d ? d.displayName || d.name : "", $e = Ye ? qe(Ye) : "";
      return typeof d == "function" && me.set(d, $e), $e;
    }
    function v(d, g, b) {
      return ze(d, !1);
    }
    ...
    var N = Object.prototype.hasOwnProperty, Q = {}, ne = j.ReactDebugCurrentFrame;
    function Ve(d) {
      if (d) {
        var g = d._owner, b = P(d.type, d._source, g ? g.type : null);
        ne.setExtraStackFrame(b);
      } else
        ne.setExtraStackFrame(null);
    }
    function kt(d, g, b, k, L) {
      {
        ...
        for (var I in d)
          if (F(d, I)) {
            ...
            try {
              ...
              R = d[I](g, I, k, b, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (q) {
              R = q;
            }
            R && !(R instanceof Error) && (Ve(L), O("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", k || "React class", b, I, typeof R), Ve(null)), R instanceof Error && !(R.message in Q) && (Q[R.message] = !0, Ve(L), O("Failed %s type: %s", b, R.message), Ve(null));
          }
      }
    }
    ...
    function Cr(d) {
      if (tn(d))
        return O("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", en(d)), Pr(d);
    }
    ...
    function an(d, g) {
      if (typeof d.ref == "string" && nt.current && g && nt.current.stateNode !== g) {
        ...
        Gt[b] || (O('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', J(nt.current.type), d.ref), Gt[b] = !0);
      }
    }
    function on(d, g) {
      {
    ...
    function un(d, g, b, k, L) {
      {
        var F, I = {}, R = null, X = null;
        b !== void 0 && (Cr(b), R = "" + b), nn(g) && (Cr(g.key), R = "" + g.key), sn(g) && (X = g.ref, an(g, L));
        for (F in g)
          N.call(g, F) && !rn.hasOwnProperty(F) && (I[F] = g[F]);
        if (d && d.defaultProps) {
        ...
        return ln(d, R, X, L, k, nt.current, I);
      }
    }
    ...
    function Mr(d, g) {
      {
        ...
        Dr[b] = !0;
        var k = "";
        d && d._owner && d._owner !== Jt.current && (k = " It was passed a child from " + J(d._owner.type) + "."), He(d), O('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', b, k), He(null);
      }
    }
    function Nr(d, g) {
      {
    ...
    function gn(d) {
      {
        for (var g = Object.keys(d.props), b = 0; b < g.length; b++) {
          var k = g[b];
          if (k !== "children" && k !== "key") {
            He(d), O("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", k), He(null);
            break;
          }
        }
    ...
    function Ur(d, g, b, k, L, F) {
      {
        ...
        if (!I) {
          ...
          X ? R += X : R += Ir();
          var q;
          d === null ? q = "null" : Yt(d) ? q = "array" : d !== void 0 && d.$$typeof === t ? (q = "<" + (J(d.type) || "Unknown") + " />", R = " Did you accidentally export a JSX literal instead of a component?") : q = typeof d, O("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", q, R);
        }
        var z = un(d, g, b, L, F);
        if (z == null)
          return z;
        ...
        if (N.call(g, "key")) {
          var $e = J(d), Z = Object.keys(g).filter(function(wn) {
            return wn !== "key";
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, Qt, $e, _n, $e), Lr[$e + Qt] = !0;
          }
        }
...
var p = ur.exports, dr, jn = {}, Et = xn;
if (jn.NODE_ENV === "production")
  dr = Et.createRoot, Et.hydrateRoot;
else {
  var zr = Et.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
  dr = function(s, e) {
...
var te = {}, Er = {}, Mt = {}, mt = {}, Nt = {}, Lt = {}, Vn = function() {
  if (typeof self < "u")
    return self;
  if (typeof window < "u")
    return window;
...
const Hn = Ze.fetch, xs = Ze.fetch.bind(Ze), Ss = Ze.Headers, Yn = Ze.Request, Gn = Ze.Response, et = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Headers: Ss,
  Request: Yn,
  Response: Gn,
...
class Pi {
  ...
  connect() {
    if (!this.conn) {
      ...
      }), import("./browser-UbRoQRvF.js").then((e) => e.b).then(({ default: e }) => {
...
const tr = (s) => s.msg || s.message || s.error_description || s.error || JSON.stringify(s), Ii = (s, e, t) => Fe(void 0, void 0, void 0, function* () {
  const r = yield $i();
...
const De = (s) => s.msg || s.message || s.error_description || s.error || JSON.stringify(s), Ea = [502, 503, 504];
async function es(s) {
  var e;
  if (!la(s))
    throw new yr(De(s), 0);
  if (Ea.includes(s.status))
    throw new yr(De(s), s.status);
  let t;
  try {
    t = await s.json();
  } catch (i) {
  ...
  if (n && n.getTime() >= Fs["2024-01-01"].timestamp && typeof t == "object" && t && typeof t.code == "string" ? r = t.code : typeof t == "object" && t && typeof t.error_code == "string" && (r = t.error_code), r) {
    if (r === "weak_password")
      throw new Zr(De(t), s.status, ((e = t.weak_password) === null || e === void 0 ? void 0 : e.reasons) || []);
    ...
    throw new Zr(De(t), s.status, t.weak_password.reasons);
...
async function Ta(s, e, t, r, n, i) {
  ...
  try {
    ...
    throw console.error(c), new yr(De(c), 0);
  }
...
class gt {
  ...
  constructor(e) {
    ...
    }, this.persistSession ? n.storage ? this.storage = n.storage : ft() ? this.storage = Ia : (this.memoryStorage = {}, this.storage = rs(this.memoryStorage)) : (this.memoryStorage = {}, this.storage = rs(this.memoryStorage)), pe() && globalThis.BroadcastChannel && this.persistSession && this.storageKey) {
      try {
  ...
  async signUp(e) {
    ...
    try {
      ...
      if ("email" in e) {
        ...
        let m = null, _ = null;
        this.flowType === "pkce" && ([m, _] = await Je(this.storage, this.storageKey)), i = await $(this.fetch, "POST", `${this.url}/signup`, {
          headers: this.headers,
...
const qa = (s, e, t) => new Ba(s, e, t), za = "https://zozodfjzxzlwzkhmfhwh.supabase.co", Va = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inpvem9kZmp6eHpsd3praG1maHdoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzIwNDM3MjMsImV4cCI6MjA0NzYxOTcyM30.ywmi4WD1fZN3hRu-krtGmY1-IYSJSODh1tKK4Ytt18Q", W = qa(za, Va);
function ue(s) {
...
function Io(s) {
  const e = ue(s), t = +Dt(e) - +Ja(e);
  return Math.round(t / Vs) + 1;
}
function Ys(s, e) {
  var l, h, f, m;
  const t = ue(s), r = t.getFullYear(), n = qt(), i = (e == null ? void 0 : e.firstWeekContainsDate) ?? ((h = (l = e == null ? void 0 : e.locale) == null ? void 0 : l.options) == null ? void 0 : h.firstWeekContainsDate) ?? n.firstWeekContainsDate ?? ((m = (f = n.locale) == null ? void 0 : f.options) == null ? void 0 : m.firstWeekContainsDate) ?? 1, a = Le(s, 0);
  a.setFullYear(r + 1, 0, i), a.setHours(0, 0, 0, 0);
  const o = pt(a, e), c = Le(s, 0);
...
function Do(s, e) {
  var o, c, u, l;
  const t = qt(), r = (e == null ? void 0 : e.firstWeekContainsDate) ?? ((c = (o = e == null ? void 0 : e.locale) == null ? void 0 : o.options) == null ? void 0 : c.firstWeekContainsDate) ?? t.firstWeekContainsDate ?? ((l = (u = t.locale) == null ? void 0 : u.options) == null ? void 0 : l.firstWeekContainsDate) ?? 1, n = Ys(s, e), i = Le(s, 0);
...
var _r = { exports: {} }, ir = {}, Rt = { exports: {} }, ar = {};
/**
 * @license React
...
})(), xc = 20, $t = /* @__PURE__ */ new Map(), Sc = 1e3, ws = (s) => {
  if ($t.has(s)) return;
  let e = setTimeout(() => {
    $t.delete(s), Vt({ type: 4, toastId: s });
  }, Sc);
  $t.set(s, e);
}, kc = (s) => {
  let e = $t.get(s);
...
}, Ec = [], lr = { toasts: [], pausedAt: void 0 }, Vt = (s) => {
...
`, Fc = ({ toast: s }) => {
  ...
  return e !== void 0 ? typeof e == "string" ? se.createElement(Uc, null, e) : e : t === "blank" ? null : se.createElement(Nc, null, se.createElement(Ac, { ...r }), t !== "loading" && se.createElement(Mc, null, t === "error" ? se.createElement(Cc, { ...r }) : se.createElement(Dc, { ...r })));
}, Wc = (s) => `
...
se.memo(({ toast: s, position: e, style: t, children: r }) => {
  let n = s.height ? Yc(s.position || e || "top-center", s.visible) : { opacity: 0 }, i = se.createElement(Fc, { toast: s }), a = se.createElement(Hc, { ...s.ariaProps }, xr(s.message, s));
  return se.createElement(Vc, { className: s.className, style: { ...n, ...t, ...s.style } }, typeof r == "function" ? r({ icon: i, message: a }) : se.createElement(se.Fragment, null, i, a));
});
yc(se.createElement);
zt`
  z-index: 9999;
...
})), bs = "chatbot_session_id", Kc = 180, At = {
  chatWidth: "380px",
  chatHeight: "380px",
  verticalPosition: "bottom",
  verticalOffset: "15px",
  toggleButtonSize: "48px"
}, Xc = () => /* @__PURE__ */ p.jsxs("div", { className: "flex gap-2", children: [
  /* @__PURE__ */ p.jsx("div", { className: "w-8 h-8 rounded-full bg-gray-100 flex-shrink-0 flex items-center justify-center", children: "🤖" }),
...
function Zc({ domainId: s }) {
  const [e, t] = K(!1), [r, n] = K(""), [i, a] = K([]), [o, c] = K([]), [u, l] = K("history"), [h, f] = K(null), [m, _] = K(!1), [y] = K(/* @__PURE__ */ new Set()), [x, C] = K(null), [j, O] = K(null), E = Wr(null), [S, M] = K(!1), D = Wr(null), { sendMessage: G } = Jc(), [ce, V] = K(!1), [be, Re] = K(window.innerWidth), [de, J] = K(!0);
  ge(() => {
    const v = () => {
  ...
  const Se = async () => {
    ...
    try {
      ...
      w && (a(w), y.clear(), w.forEach((P) => y.add(P.id))), v.status === "archived" && me(v.rating || null), l("chat");
    } catch (w) {
  ...
  ge(() => {
      ...
      (w) => {
        if (console.log("Received real-time event:", w), w.eventType === "INSERT") {
          ...
          console.log("New message:", P), a((N) => {
            ...
            return y.add(P.id), P.sender_type === "bot" && rt(), console.log("Adding new message to state"), [...Q, P];
          });
        }
      }
    );
    ...
    (async () => {
      let w = localStorage.getItem(bs);
      w || (w = window.crypto.randomUUID(), localStorage.setItem(bs, w)), O(w), await bt(w);
    })();
  }, []);
  const bt = async (v) => {
    try {
      const { data: w, error: P } = await W.from("conversations").select("*").eq("session_id", v).eq("status", "active").order("last_message_at", { ascending: !1 }).limit(1);
      if (P) throw P;
      if (!w || w.length === 0) {
        console.log("No active conversations found for this session");
        return;
      }
      const N = w[0], Q = /* @__PURE__ */ new Date();
      ...
      if (ne) {
        const Ve = ne.filter((kt) => y.has(kt.id) ? !1 : (y.add(kt.id), !0));
        a(Ve);
      }
    } catch (w) {
    ...
    try {
      ...
      const { data: w, error: P } = await W.from("conversations").insert({
        domain_id: s,
        user_id: v.id,
        session_id: j,
        last_message_at: (/* @__PURE__ */ new Date()).toISOString(),
    ...
    try {
      ...
      a((Q) => he(N, Q) ? Q : [...Q, N]), await G(v, P), n("");
    } catch (w) {
  ...
  const [A, Ae] = K({
    ...
    const w = v === "sm" ? "w-8 h-8" : "w-10 h-10";
    return A.logoUrl ? /* @__PURE__ */ p.jsx(
      "img",
      {
        src: A.logoUrl,
        alt: A.chatbotName,
        className: `${w} rounded-full object-cover flex-shrink-0`
      }
    ) : /* @__PURE__ */ p.jsx("div", { className: `${w} rounded-full bg-gray-100 flex-shrink-0 flex items-center justify-center`, children: /* @__PURE__ */ p.jsx("span", { className: v === "sm" ? "text-base" : "text-lg", children: "🤖" }) });
  };
  return /* @__PURE__ */ p.jsxs(
    "div",
    {
      className: `fixed ${A.verticalPosition}-0 right-6 flex flex-col items-end z-[9999]`,
      style: { [A.verticalPosition]: A.verticalOffset },
      children: [
        e && /* @__PURE__ */ p.jsxs(
          "div",
          {
            ...
            style: {
              width: H() ? "100%" : A.chatWidth
            },
            children: [
              /* @__PURE__ */ p.jsxs("div", { className: "p-4 border-b flex items-center gap-3", style: { backgroundColor: A.color }, children: [
                ...
                /* @__PURE__ */ p.jsx("div", { className: "flex-1", children: /* @__PURE__ */ p.jsx("h3", { className: "font-medium", style: { color: A.headerTextColor }, children: A.chatbotName }) }),
              ...
              /* @__PURE__ */ p.jsx(
                "div",
                {
                  ...
                  style: {
                    height: H() ? "auto" : u === "history" ? "calc(" + A.chatHeight + " + 107px)" : A.chatHeight
                  },
                  children: u === "history" ? /* @__PURE__ */ p.jsxs("div", { className: "space-y-4 h-full", children: [
                      ...
                      /* @__PURE__ */ p.jsxs("div", { className: "flex flex-col items-end gap-1", children: [
                        /* @__PURE__ */ p.jsxs(
                          "button",
                          {
                            ...
                            style: { backgroundColor: A.color, color: A.headerTextColor },
                    ...
                    u === "chat" && /* @__PURE__ */ p.jsxs("div", { className: "flex gap-2", children: [
                      /* @__PURE__ */ p.jsx(ze, { size: "sm" }),
                      /* @__PURE__ */ p.jsxs("div", { className: "p-3 rounded-lg max-w-[80%]", style: { backgroundColor: A.agentMessageColor }, children: [
                        /* @__PURE__ */ p.jsx("p", { className: "text-sm", style: { color: A.agentMessageTextColor }, children: A.greetingMessage }),
                        /* @__PURE__ */ p.jsx("span", { className: "text-xs mt-1 block opacity-75", style: { color: A.agentMessageTextColor }, children: Ct(/* @__PURE__ */ new Date(), "h:mm a") })
                      ] })
                    ] }),
                    i.map((v) => /* @__PURE__ */ p.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          v.sender_type === "bot" && /* @__PURE__ */ p.jsx(ze, { size: "sm" }),
                          /* @__PURE__ */ p.jsxs(
                            "div",
                            {
                              className: "p-3 rounded-lg max-w-[80%]",
                              style: {
                                backgroundColor: v.sender_type === "user" ? A.userMessageColor : A.agentMessageColor
                              },
                              children: [
                                /* @__PURE__ */ p.jsx("p", { className: "text-sm", style: {
                                  color: v.sender_type === "user" ? A.userMessageTextColor : A.agentMessageTextColor
                                }, children: v.content }),
        ...
        /* @__PURE__ */ p.jsx(
          "button",
          {
            ...
            style: {
              backgroundColor: A.color,
              width: A.toggleButtonSize,
              height: A.toggleButtonSize
            },
            onClick: () => t(!e),
            children: e ? /* @__PURE__ */ p.jsx("span", { style: { fontSize: "24px" }, children: "×" }) : /* @__PURE__ */ p.jsx(Qc, {})
          }
        )
      ]
    }
...
function el() {
  ...
  dr(s).render(/* @__PURE__ */ p.jsx(Zc, { domainId: e.domainId }));
}
el();
export {
  Sn as g
};
//# sourceMappingURL=main-B3BHOgDj.js.map
