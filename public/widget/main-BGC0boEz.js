...
class Pi {
  ...
  connect() {
    if (!this.conn) {
      ...
      }), import("./browser-CKcv9PzV.js").then((e) => e.b).then(({ default: e }) => {
...
function Qc({ domainId: s }) {
  const [e, t] = z(!1), [r, n] = z(""), [i, a] = z([]), [o, c] = z([]), [u, l] = z("history"), [h, f] = z(null), [p, _] = z(!1), [v] = z(/* @__PURE__ */ new Set()), [S, P] = z(null), [j, O] = z(null), x = qr(null), [k, D] = z(!1), I = qr(null), { sendMessage: Y } = Gc(), [ne, B] = z(!1), [ce, qe] = z(380), [le, G] = z(380), [ee, be] = z(1), [me, Re] = z(11);
  fe(() => {
...
//# sourceMappingURL=main-BGC0boEz.js.map
