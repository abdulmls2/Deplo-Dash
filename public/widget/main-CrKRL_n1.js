...
class Pi {
  ...
  connect() {
    if (!this.conn) {
      ...
      }), import("./browser-CydIpI3j.js").then((e) => e.b).then(({ default: e }) => {
...
function Zc({ domainId: s }) {
  const [e, t] = X(!1), [r, n] = X(""), [i, a] = X([]), [o, c] = X([]), [u, l] = X("history"), [h, f] = X(null), [p, _] = X(!1), [y] = X(/* @__PURE__ */ new Set()), [S, P] = X(null), [j, O] = X(null), E = Ur(null), [x, M] = X(!1), I = Ur(null), { sendMessage: Y } = Jc(), [ce, V] = X(!1), [be, Re] = X(window.innerWidth), [le, G] = X(null);
  ge(() => {
    const v = () => {
  ...
  const xe = async () => {
    if (o.filter((v) => v.status === "active").length >= 2) {
      G("You can only have 2 active conversations at a time."), setTimeout(() => G(null), 3e3);
      return;
    }
...
//# sourceMappingURL=main-CrKRL_n1.js.map
