...
class Pi {
  ...
  connect() {
    if (!this.conn) {
      ...
      }), import("./browser-CS0GfVqa.js").then((e) => e.b).then(({ default: e }) => {
...
const Jc = async (s, e, t, r) => {
  ...
  sendMessage: async (t, r) => {
    ...
    try {
      const { data: n } = await U.from("conversations").select("domain_id").eq("id", r).single(), { data: i } = await U.from("domain_settings").select("chatbot_name, prompt").eq("domain_id", n == null ? void 0 : n.domain_id).single(), { data: a, error: o } = await U.from("training_data").select("content").eq("domain_id", n == null ? void 0 : n.domain_id);
      o && console.error("Error fetching training data:", o), console.log("Domain ID:", n == null ? void 0 : n.domain_id), console.log("Training data result:", a);
      const c = i == null ? void 0 : i.chatbot_name, u = i == null ? void 0 : i.prompt, l = a && a.length > 0 ? a.map((S) => S.content).join(`
...
`) : void 0;
      ...
      a && a.length > 0 ? console.log(`Found ${a.length} training data entries:`, l) : console.log("No training data found for domain"), console.log(`Sending user message from ${c}:`, t);
      const h = {
        conversation_id: r,
        content: t,
        sender_type: "user",
...
//# sourceMappingURL=main-DXFm7aMx.js.map
